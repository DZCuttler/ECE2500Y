...
class bottlefit_bottleneck(nn.Module):
    def __init__(self, encoder, decoder, tail, quantizer=None):
        super(bottlefit_bottleneck, self).__init__()
        self.encoder = encoder
        self.decoder = decoder
        self.tail = tail

        self.quantizer = quantizer
        self.quantize = quantizer is not None
